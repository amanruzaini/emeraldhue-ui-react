...
| ---------------------------- | ----------------------------------------- | ---------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| Button                       | `button/Button.tsx`                       | Scratch, CVA           | Complete | Code-first API: children, startIcon/endIcon, iconOnly, shortcut. Shortcut renders variant-aware <kbd> badges (string                                                                                                                                               | string[]). Destructive xs has unique px-1 py-2 padding (compound variant). |
